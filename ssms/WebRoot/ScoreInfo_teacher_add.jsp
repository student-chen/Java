...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <s:form action="ScoreInfo/ScoreInfo_TeacherAddScoreInfo.action" method="post" id="scoreInfoAddForm" onsubmit="return checkForm();"  enctype="multipart/form-data" name="form1">
