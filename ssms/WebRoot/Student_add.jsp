...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>家庭地址:</td>
    <td width=70%><textarea id="student.studentAddress" name="student.studentAddress" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>附加信息:</td>
    <td width=70%><textarea id="student.studentMemo" name="student.studentMemo" rows="5" cols="50"></textarea></td>
  </tr>
