...
public class StudentSelectCourseInfoDAO {
    ...
    /*查询StudentSelectCourseInfo信息*/
    public ArrayList<StudentSelectCourseInfo> QueryStudentSelectCourseInfoInfo(String studentNumber) { 
        Session s = null; 
        try {
            s = HibernateUtil.getSession();
            String hql = "From StudentSelectCourseInfo studentSelectCourseInfo where 1=1";
            if(null != studentNumber && !studentNumber.equals("")) hql += " and studentSelectCourseInfo.studentNumber.studentNumber='" + studentNumber + "'";
             Query q = s.createQuery(hql);
            /*计算当前显示页码的开始记录*/ 
            List studentSelectCourseInfoList = q.list();
            return (ArrayList<StudentSelectCourseInfo>) studentSelectCourseInfoList;
    ...
    /*根据课程编号查询选课信息*/
    public ArrayList<StudentSelectCourseInfo> QueryStudentSelectCourseInfoInfoByCourseNumber(
			String courseNumber) {
    	 Session s = null; 
         try {
             s = HibernateUtil.getSession();
             String hql = "From StudentSelectCourseInfo studentSelectCourseInfo where 1=1";
             if(null != courseNumber && !courseNumber.equals("")) hql += " and studentSelectCourseInfo.courseNumber.courseNumber='" + courseNumber + "'";
              Query q = s.createQuery(hql);
             /*计算当前显示页码的开始记录*/ 
             List studentSelectCourseInfoList = q.list();
             return (ArrayList<StudentSelectCourseInfo>) studentSelectCourseInfoList;
